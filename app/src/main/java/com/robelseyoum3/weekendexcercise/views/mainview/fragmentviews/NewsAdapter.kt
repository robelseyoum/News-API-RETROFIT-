...
class NewsAdapter(private val newSource: NewsSource, private val listener: onNewsClickListener)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsViewHolder {
        ...
        return NewsViewHolder(parent.inflate(R.layout.activity_news_row))
    }
    ...
    override fun onBindViewHolder(holder: NewsViewHolder, position: Int) {
        ...
        //holder.tvAuthor.setBoldAndColorSpannable(newSource.articles[position].author)

       // holder.tvTitle.text = newSource.articles[position].title
        holder.tvTitle.setBoldAndColorSpannable(newSource.articles[position].title)

        //holder.tvDescription.text = newSource.articles[position].description
        holder.tvDescription.setBoldAndColorSpannable(newSource.articles[position].description)
